...
export function ConfirmDeleteDialog({
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      console.error("Error deleting logistics entity:", error);
    } finally {
      setIsLoading(false);
    }
  };
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-red-700 dark:text-red-300">
                  Menghapus entitas logistik ini akan:
                </p>
                <ul className="text-sm text-red-700 dark:text-red-300 list-disc list-inside space-y-1 ml-2">
                  <li>Menghapus semua data terkait entitas ini</li>
                  <li>
                    Mempengaruhi laporan dan analisis yang menggunakan data ini
                  </li>
